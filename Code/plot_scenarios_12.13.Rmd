---
title: "Plots for simulation scenarios with 80 confidence interval for scenarios 1.1 to 1.4"
author: "Xinru WANG"
date: "2023-12-13"
...
files = list.files(path = paste0(wd, 'Code/Run_output'), full.names = TRUE, pattern = "iter100_2023-12-13.rds")
