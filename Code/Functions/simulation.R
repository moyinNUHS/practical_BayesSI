...
simulation <- function(N,
  ...
  est_method_C2 <-
    fit_onestage_C_hier(sim_data[['trial_data']]) # use original current data
  est_method_C2_NI <-
    fit_onestage_C_hier_NI(sim_data[['trial_data']]) # use original current data
  est_method_C2_wk <-
    fit_onestage_C_hier_prior(sim_data[['prior_data']], sim_data[['trial_data']], Scale_wk) # use original current data + original prior data
  est_method_C2_str <-
    fit_onestage_C_hier_prior(sim_data[['prior_data']], sim_data[['trial_data']], Scale_str) # use original current data + original prior data
