---
title: "Plots for simulation scenarios with 95 confidence interval for scenarios 1.1 to 1.4"
author: "Xinru WANG"
date: "2023-12-05"
...
files = list.files(path = paste0(wd, 'Code/Run_output'), full.names = TRUE, pattern = "iter100_2023-12-01.rds")
